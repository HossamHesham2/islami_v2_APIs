class PrayResponse {
  ...
  PrayResponse({this.code, this.status, this.data});

  PrayResponse.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    date = json['date'] != null ? DateData.fromJson(json['date']) : null;
    meta = json['meta'] != null ? Meta.fromJson(json['meta']) : null;
  }

  Map<String, dynamic> toJson() {
    final data = <String, dynamic>{};
    if (timings != null) data['timings'] = timings!.toJson();
...
class DateData {
  ...
  DateData({this.readable, this.timestamp, this.hijri, this.gregorian});
...
class Method {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = id;
    data['name'] = name;
    if (params != null) data['params'] = params!.toJson();
